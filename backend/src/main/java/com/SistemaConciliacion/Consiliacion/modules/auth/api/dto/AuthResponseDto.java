...
public record AuthResponseDto(String token, String tokenType, String username, AppRole role) {
	public static AuthResponseDto of(String token, String username, AppRole role) {
