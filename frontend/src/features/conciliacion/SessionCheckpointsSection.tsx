...
export function SessionCheckpointsSection({
  ...
  return (
    <section className="checkpoints-panel" aria-labelledby="session-checkpoints-title">
      <div id="session-checkpoints-title" className="checkpoints-panel-head">
      ...
      <div className="checkpoints-panel-body">
