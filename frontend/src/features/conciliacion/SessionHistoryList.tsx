            ...
            <li key={s.id}>
              <article
                className={[
                  ...
                  isActive ? 'session-history-card--active' : '',
                  isClosed ? 'session-history-card--closed' : 'session-history-card--open',
                ]
                  .filter(Boolean)
                  .join(' ')}
              >
                <div className="session-history-card-main">
                  <div className="session-history-card-head">
                    <div className="session-history-card-title-row">
                      <span className="session-history-card-id">#{s.id}</span>
      ...
      {editing ? (
        <div className="session-display-name-form">
          ...
          <div className="session-display-name-actions">
            ...
            <button
              type="button"
              className="btn-secondary session-display-name-save"
              disabled={saving}
              onClick={() => void save()}
            >
